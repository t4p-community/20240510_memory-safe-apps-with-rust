...
pub struct PersonReporter<'a> {
    // person is a borrow reference, PersonReporter does not own it
    // we need to ensure person outlives PersonReporter
    pub person: &'a Person,
}

impl<'a> PersonReporter<'a> {
